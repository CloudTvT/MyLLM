...
void rmsnorm_kernel_cu(const tensor::Tensor& input, const tensor::Tensor& weight,
  ...
  CHECK(input.device_type() == kuiper_base::DeviceType::kDeviceCUDA &&
        weight.device_type() == kuiper_base::DeviceType::kDeviceCUDA &&
        output.device_type() == kuiper_base::DeviceType::kDeviceCUDA);
