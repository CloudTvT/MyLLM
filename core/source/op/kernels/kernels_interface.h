...
namespace kernel{
  ...
  typedef void (*MHAKernel)(int32_t pos, int32_t head_num, int32_t layer_index, int32_t seq_len,
                          ...
                          const tensor::Tensor& value_cache_tensor, kuiper_base::DeviceType device_type,
                          CudaConfig*);
  ...
  SwigluKernel get_swiglu_kernel(kuiper_base::DeviceType device_type, void* stream = nullptr);
